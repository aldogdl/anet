...
class SysCom
{
    ...
    private ?NextSeller $nextSeller = null;
    ...
    public function getNextSeller(): ?NextSeller
    {
        return $this->nextSeller;
    }

    public function setNextSeller(NextSeller $nextSeller): static
    {
        // set the owning side of the relation if necessary
        if ($nextSeller->getSeller() !== $this) {
            $nextSeller->setSeller($this);
        }

        $this->nextSeller = $nextSeller;
